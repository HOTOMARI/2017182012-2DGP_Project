...
class ShieldMan(Monster):
    def __init__(self, party_num):
        super(ShieldMan, self).__init__('방패맨', Monster_Data['ShieldMan']['HP'], Monster_Data['ShieldMan']['EXP'],
                                   Monster_Data['ShieldMan']['ATK'], Monster_Data['ShieldMan']['DEF'],
                                   Monster_Data['ShieldMan']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_005.png')
