...
class Convert(Skill):
    ...
    def activate(self, my_index):
        GPD.Battlelog.append(self.name + '의 생명력변환')
        GPD.Battlelog.append(self.name + '의 HP ' + str(int(GPD.players[my_index].HP * 0.2)) + '감소')
        GPD.Battlelog.append(self.name + '의 MP ' + str(int(GPD.players[my_index].HP * 0.2)) + '회복')
