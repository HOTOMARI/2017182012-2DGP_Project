...
class Snake(Monster):
    def __init__(self, party_num):
        super(Snake, self).__init__('뱀', Monster_Data['Snake']['HP'], Monster_Data['Snake']['EXP'],
                                   Monster_Data['Snake']['ATK'], Monster_Data['Snake']['DEF'],
                                   Monster_Data['Snake']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_008.png')
