...
class Flower(Monster):
    def __init__(self, party_num):
        super(Flower, self).__init__('꽃', Monster_Data['Flower']['HP'], Monster_Data['Flower']['EXP'],
                                   Monster_Data['Flower']['ATK'], Monster_Data['Flower']['DEF'],
                                   Monster_Data['Flower']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_010.png')
