...
class Slime(Monster):
    def __init__(self, party_num):
        super(Slime, self).__init__('슬라임', Monster_Data['Slime']['HP'], Monster_Data['Slime']['EXP'],
                                   Monster_Data['Slime']['ATK'], Monster_Data['Slime']['DEF'],
                                   Monster_Data['Slime']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_002.png')
