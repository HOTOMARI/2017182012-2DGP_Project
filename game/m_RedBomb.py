...
class RedBomb(Monster):
    def __init__(self, party_num):
        super(RedBomb, self).__init__('봄', Monster_Data['RedBomb']['HP'], Monster_Data['RedBomb']['EXP'],
                                   Monster_Data['RedBomb']['ATK'], Monster_Data['RedBomb']['DEF'],
                                   Monster_Data['RedBomb']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_004.png')
