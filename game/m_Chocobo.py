...
class Chocobo(Monster):
    def __init__(self, party_num):
        super(Chocobo, self).__init__('초코보', Monster_Data['Chocobo']['HP'], Monster_Data['Chocobo']['EXP'],
                                   Monster_Data['Chocobo']['ATK'], Monster_Data['Chocobo']['DEF'],
                                   Monster_Data['Chocobo']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_003.png')
