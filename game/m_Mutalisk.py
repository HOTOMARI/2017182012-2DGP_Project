...
class Mutalisk(Monster):
    def __init__(self, party_num):
        super(Mutalisk, self).__init__('뮤탈', Monster_Data['Mutalisk']['HP'], Monster_Data['Mutalisk']['EXP'],
                                   Monster_Data['Mutalisk']['ATK'], Monster_Data['Mutalisk']['DEF'],
                                   Monster_Data['Mutalisk']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_009.png')
