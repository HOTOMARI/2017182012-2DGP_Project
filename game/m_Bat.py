...
class Bat(Monster):
    def __init__(self, party_num):
        super(Bat, self).__init__('박쥐', Monster_Data['Bat']['HP'], Monster_Data['Bat']['EXP'],
                                   Monster_Data['Bat']['ATK'], Monster_Data['Bat']['DEF'],
                                   Monster_Data['Bat']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_007.png')
