...
class BlueBomb(Monster):
    def __init__(self, party_num):
        super(BlueBomb, self).__init__('보오옴', Monster_Data['BlueBomb']['HP'], Monster_Data['BlueBomb']['EXP'],
                                   Monster_Data['BlueBomb']['ATK'], Monster_Data['BlueBomb']['DEF'],
                                   Monster_Data['BlueBomb']['MONEY'])
        self.frame = random.randint(0, 3) % 4
        self.party_num = party_num
        self.image = load_image('image\\monster\\monster_011.png')
