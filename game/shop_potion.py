...
def draw():
    ...
    # 구입메뉴
        ...
        # 아니면 회색글씨로 표시
        for i in range(0,4):
            if GPD.items[i].COST * sel_num[i] <= GPD.money:
                GPD.Ingame_Big_font.font.draw(100, 330 - 70*i, GPD.items[i].name, White_font)
                GPD.Ingame_Big_font.font.draw(250, 330 - 70*i, str(sel_num[i]) + '개', White_font)
                GPD.Ingame_Big_font.font.draw(550, 330 - 70*i, str(GPD.items[i].COST * sel_num[i]) + '원', White_font)
            else:
                GPD.Ingame_Big_font.font.draw(100, 330 - 70*i, GPD.items[i].name, Gray_font)
                GPD.Ingame_Big_font.font.draw(250, 330 - 70*i, str(sel_num[i]) + '개', Gray_font)
                GPD.Ingame_Big_font.font.draw(550, 330 - 70*i, str(GPD.items[i].COST * sel_num[i]) + '원', Gray_font)
